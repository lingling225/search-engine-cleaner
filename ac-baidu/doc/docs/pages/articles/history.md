...
head:
  - - meta
    - name: keywords
      content: Search Engine Cleaner,AC-Baidu,脚本历史,更新记录,百度优化脚本,谷歌优化脚本,必应优化脚本,搜索优化脚本,搜索结果优化
---
# 更新历史记录
## 记录情况
...
|版本号|更新内容|
|------------------|----|
|2026.01-06-V27.19 | 修复谷歌、百度在不同缩放屏幕下导致的错位问题
|2025.10-22-V27.18 | 修复谷歌、百度在不同缩放屏幕下导致的错位问题
|2025.07-12-V27.17 | 修复谷歌单双列样式表问题、优化百度样式表；增加less.js资源，避免jsdelivr异常无法加载
