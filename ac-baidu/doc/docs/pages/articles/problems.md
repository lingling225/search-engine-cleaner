...
> 1. 检查是否安装顺利，安装失败的可能需要重新安装一下，注意最新的版本是27.19，`27.09`版本有百度显示不全的问题（这个版本刚好是greasyfork被墙时间的版本，打不开greayfork走代理，用梯子解决greasyfork打不开的问题：<a href='https://bboo.boo/#/?code=g4WEkq4j' target='_blank'>一元机场.PLUS</a>）
