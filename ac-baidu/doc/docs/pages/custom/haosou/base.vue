<template>
  <div>
    <el-form :model="state" label-width="auto" style="max-width: 800px">
      <div class="config-group-title"><span>常用设置</span><small>360 搜索与好搜页面效果</small></div>
...
<!--      <el-divider />-->
      <el-form-item data-config-key="HuYanMode HuYanMode_Color" for="nothing" label-position="left">
        <template #label>
          <span>360 / 好搜护眼模式</span>
          <el-tooltip effect="dark" content="好搜护眼模式，注意根据不同的主题，请自己选择" placement="top">
